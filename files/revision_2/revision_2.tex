...
\frame{
   ...
   \begin{itemize}
    ...
    \item The flexibility of adding/removing elements from a list comes with a cost. List elements may not be stored in contiguous areas of memory and Python therefore has to look up where the elements are stored. This is called indirect addressing.
    \item In contrast, arrays are generally {\color{red}faster than lists} because the elements are stored in contiguous areas of memory.
   \end{itemize}
}
